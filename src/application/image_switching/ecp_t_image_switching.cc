...
//	char config_section_name2[] = { "[object_follower_pb]" };
	...
	boost::shared_ptr <discode_sensor> ds1 = boost::shared_ptr <discode_sensor>(new discode_sensor(config, config_section_name1));
	eih = boost::shared_ptr<visual_servo> (new pb_eih_visual_servo(reg, ds1, config_section_name1, config));
