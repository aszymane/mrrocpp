...
#include "ternary_changing_image_switching.h"
...
ternary_changing_image_switching::ternary_changing_image_switching(mrrocpp::ecp::common::task::task & ecp_task, const char * section_name1, boost::shared_ptr <
	...
	visual_servo_manager(ecp_task, section_name1)
{
	...
	if(fboth!=NULL)
		...
		printf("ternary_changing_image_switching: Failed to open file\n");
}

ternary_changing_image_switching::~ternary_changing_image_switching()
{
}

lib::Homog_matrix ternary_changing_image_switching::get_aggregated_position_change()
{
...
void ternary_changing_image_switching::configure_all_servos()
{
	//logger::logDbg("ternary_changing_image_switching::configure_all_servos()\n");
}
